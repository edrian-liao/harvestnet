...
class Config_Satlas:
    def __init__(self):
        ...
        self.output_path = "/atlas2/u/XXXX-2/harvest-piles/results/satlas.pth"
...
class Swin_Pretrain:
    def __init__(self):
        ...
        self.output_path = os.path.join(
            "/atlas2/u/XXXX-2/harvest-piles/results/swin_pretrain",
...
class Config_Swin_Finetune:
    def __init__(self):
        ...
        self.dataset_path = os.path.join(ROOT_PATH, "datasets")
        self.output_path = os.path.join(
            "/atlas2/u/XXXX-2/harvest-piles/results/swin_finetune",
            "%s" % (datetime.datetime.now().strftime("%d-%m-%Y-%H-%M-%S")),
        )
